...
> This project is based on the [jdbcspy](https://github.com/lbaeumer/jdbcspy) project.  It using Log4J2 instead for  logging, adds a ResultSet leak monitor and simplifies some of the setup.  Not meant for general usage.  Eventually  look to cleanup configuration.
